...
import { isAuthenticated, logout, getCurrentUser, isAdmin, canProcessPayroll } from "@/lib/auth"
...
// Format time as relative (e.g., "5 min ago")
...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const [userCanProcessPayroll, setUserCanProcessPayroll] = useState(false)
  ...
  useEffect(() => {
    ...
    setUserCanProcessPayroll(canProcessPayroll())
    loadNotifications()
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-950 flex">
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto p-4 space-y-1">
          ...
          <div className="pt-4">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="font-semibold">Incidences</span>
              </div>
            ...
            {openSections.incidences && (
              <div className="mt-1 space-y-1">
                ...
                <NavLink href="/incidences/types" indent>
                  <Tag size={18} />
                  <span>Incidence Types</span>
                </NavLink>
                <NavLink href="/incidences/vacations" indent>
                  <Palmtree size={18} />
                  <span>Vacations</span>
                </NavLink>
                <NavLink href="/hr/calendar" indent>
                  <Calendar size={18} />
          ...
          {/* Payroll Section - Only for admin and payroll roles */}
          {mounted && userCanProcessPayroll && (
            <div className="pt-4">
              <button
            ...
            <div className="pt-4">
              ...
              {openSections.admin && (
                <div className="mt-1 space-y-1">
                  ...
                  <NavLink href="/configuration/shifts" indent>
                    <Clock size={18} />
                    <span>Shifts</span>
                  </NavLink>
                  <NavLink href="/admin/permissions" indent>
                    <ShieldCheck size={18} />
                    <span>Permissions</span>
                  </NavLink>
                  <NavLink href="/admin/audit" indent>
                    <ShieldCheck size={18} />
                                ...
                                <div className="flex items-center justify-between mt-1 text-slate-500 text-xs">
                                  ...
                                  {notification.actor_user && (
                                    <span className="text-slate-600">
                                      by {notification.actor_user.full_name}
                                    </span>
                                  )}
                                </div>
                              </div>
