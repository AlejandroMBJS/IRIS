    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Bienvenido al Portal del Empleado",
        })
        ...
        <CardHeader className="space-y-1">
          <div className="flex items-center justify-center mb-4">
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-xl font-medium text-slate-400">Portal</span>
            </div>
          </div>
          ...
          <CardDescription className="text-center text-slate-400">
            Ingresa tus credenciales para acceder al Portal del Empleado
          </CardDescription>
        </CardHeader>
        <CardContent>
